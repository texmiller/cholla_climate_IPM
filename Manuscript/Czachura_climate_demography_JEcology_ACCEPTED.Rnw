...
Our long-term data on tree cholla demography are publicly available \citep{cholla_dat_edi}. Code for our statistical and demographic modeling is available at \url{https://github.com/texmiller/cholla_climate_IPM}.
