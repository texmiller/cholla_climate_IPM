...
The study of population dynamics is particularly well suited to identifying climate drivers of population growth or abundance, and this may facilitate forecasting responses to future climate change or hind-casting responses to historical climate trends. 
...
While extinction debt is often studied as a regional process, there is recent emphasis on the underlying local dynamics whereby single populations transition from positive to negative growth rates \citep{lehtila2016forest,hylander2013mechanisms}.
In the absence of significant migration, local extinction debt is indicative of environmental change, since transient persistence suggests that the environment was favorable for population growth at some time in the past. 
However, while evidence for extinction debt is growing, the mechanismss that cause populations to tip from positive to negative growth rates are rarely known, and this information may be critical for effective conservation planning \citep{hylander2013mechanisms}. 
...
These methods derive predictions for population growth from a suite of statistical models fitted to individual-level vital rates. 
By incorporating climatic factors as statistical covariates, previous studies have identified climatic limits of population viability \citep{ilerreproductive} and forecasted population responses to particular types of climate change \citep{Adler2013}. 
...
Climate change is a multi-dimensional process that may involve shifts in the means, variances, and seasonal distributions of multiple variables related to temperature and precipitation, and, for a given region, some aspects of climate change are greater in magnitude than others (cite IPCC?). 
Yet, it is not always apparent which dimensions of climate are most important for a given species, and it is possible that subtle environmental changes can elicit strong ecological responses (cite some tipping point papers). 
Furthermore, different life stages (e.g., young vs old) and different vital rate processes (e.g., growth, survival, reproduction) may differ in the magnitude and even direction of their responses to single climate drivers \citep{dybala2013projecting}, and single life stages or vital rates may be affected by multiple drivers, including interactions \citep{dalgleish2011climate,williams2015life}. 
Ultimately, the influence of climate on population growth depends on the sensitivitities of vital rates to climate drivers and the sensitivities of $\lambda$ to the vital rates \citep{mclean2016predicting}. 
...
Our previous work with the tree cholla cactus (\textit{Cylindriopuntia imbricata} Haw. D.C.) indicated, with >$95\%$ certainty, that our focal population is in decline (stochastic population growth rate $\lambda_S < 1$) despite current densities that are reasonably high \citep{ohm2014balancing,miller2009impacts,elderd2016quantifying}.
Our study region in the northern Chihuahuan Desert (New Mexico, USA) has experienced strong climatic fluctuations over the past century, including several decadal-scale droughts interrupted by relatively wet periods \citep{peters2015beyond}. 
Recent and projected climate change in our study region includes increases in temperature and shifts in the seasonal timing of precipitation; the combined effects of these changes may further elevate drought risk \citep{petrie2014regional,cook2013response,cook2015unprecedented}. 
We sought to understand how historical climate patterns affected cactus population viability and to test the hypothesis that recent climate change has driven this population into extinction debt; this hypothesis predicts at least occasional periods of positive population growth over the past century. 
Our specific objectives were to: (1) Characterize climatic drivers of inter-annual variability in demographic rates, (2) Back-cast climate-dependent population growth to determine whether the past century included periods that were favorable for population growth, and (3) Identify which aspects of climate change and which demographic responses to climate most strongly determine temporal trends in population growth.
...
We assessed the importance of seasonal differences by examining how warm- and cool-season variables loaded onto the PCs.
...
All of the vital rates estimated from long-term data (survival, growth, reproductive status, and fertility of flowering plants) were strongly, positively size-dependent but there was heterogeneity in the magnitude and sign of responses to different dimensions of climate variability. 
Demographic vital rates were least responsive to PC1, the dominant axis of climate variability and change, and most responsive to less variable climate dimensions. 
There was also evidence for divergent responses of different vital rates to the same climate variable. 
Figure \label{figure:vital_rates} shows vital rate data and fitted statistical models (including size- and climate-dependence) following variable selection procedures that elimated coefficients that were weakly supported (Table \ref{tab:SVS}). 
...
Fertility of flowering plants was not responsive to PC1 variation (Fig. \label{figure:vital_rates}J) and growth was not responsize to any of the climate PCs (Fig. \label{figure:vital_rates}D,E,F). 
There were positive responses to PC2 in survival(Fig. \label{figure:vital_rates}B), flowering probability (Fig. \label{figure:vital_rates}H), and fertility of flowering plants (Fig. \label{figure:vital_rates}K), indicating that these vital rates were greater in years with wetter cool seasons. 
Responses to PC3 varied in sign, with survival declining at high values (cold winters and dry summers) and reproductive rates declining at low values (warm winters and wet summers) (Fig. \label{figure:vital_rates}C,I,L). 
